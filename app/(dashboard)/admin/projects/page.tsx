            ...
            <div className="space-y-8 animate-in fade-in duration-700">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    ...
                    <button 
                        ...
                        className="w-full lg:w-auto flex items-center justify-center gap-2 px-8 py-4 bg-primary text-white rounded-[2rem] hover:opacity-90 transition-all font-black shadow-2xl shadow-primary/20 active:scale-95"
                    >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="sm:col-span-2 relative group">
                            ...
                            <input
                                ...
                                className="w-full bg-background border border-border-theme rounded-2xl pl-12 pr-4 py-4 text-text-primary placeholder:text-text-secondary focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all"
                            />
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="w-full bg-background border border-border-theme rounded-2xl pl-10 pr-4 py-4 text-text-primary focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all appearance-none cursor-pointer font-bold text-sm"
                            >
                    ...
                    <div className="flex items-center gap-2 text-xs font-bold text-text-secondary px-4 uppercase tracking-widest">
                        ...
                        {searchQuery && (
                            <>
                                ...
                                <span>Filtering by "<span className="text-primary">{searchQuery}</span>"</span>
                            </>
                        )}
                    </div>
                )}
